...
botonEnviar.addEventListener('click', (evento) => {
    //Se comprueba si los valores de importe y mes están vacíos; si es así se manda un alert
...
//toFixed(nºdecimales), nos devuelve un floar con dos decimales
//Se hace un += para que se vayan acumulando todos los valores a medida que se insertan los datos mes a mes
