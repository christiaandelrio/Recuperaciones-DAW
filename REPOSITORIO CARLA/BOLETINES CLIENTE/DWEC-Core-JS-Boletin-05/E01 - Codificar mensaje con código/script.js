...
function codificarMensaje () {
    ...
    for(let i = 0; i < mensaje.length; i++ ) {
        //Recorremos el string como array de caracteres
        ...
        if ( posicion == -1 ) {  // -1 = caracter no está en cadenaReferencia
            ...
            //cada guión significa no traducir la letra
            ;
        } else if ( codigo[posicion] === '.' ) {
            //cada punto significa borrar la letra del mensaje
            //primero marcamos la letras a borrar con el símbolo ^ y luego las reemplazamos por ''
